...
#define CONFIG_SCT_nOU   (5)             /* Number of outputs */
	...
	struct S_INPUTMUX										/*!< (@ 0x4002C000) INPUTMUX Structure                                     */
	{                                    
	  LPC_REG  DMA_INMUX_INMUX0;                  /*!< (@ 0x4002C000) Input mux register for DMA trigger input 20.
															 Selects from 18 DMA trigger outputs.                                  */
	  LPC_REG  DMA_INMUX_INMUX1;                  /*!< (@ 0x4002C004) Input mux register for DMA trigger input 20.
															 Selects from 18 DMA trigger outputs.                                  */
	  LPC_REG  RESERVED0[6];
	  LPC_REG  SCT0_INMUX0;                       /*!< (@ 0x4002C020) Input mux register for SCT input 0                     */
	  LPC_REG  SCT0_INMUX1;                       /*!< (@ 0x4002C024) Input mux register for SCT input 0                     */
	  LPC_REG  SCT0_INMUX2;                       /*!< (@ 0x4002C028) Input mux register for SCT input 0                     */
	  LPC_REG  SCT0_INMUX3;                       /*!< (@ 0x4002C02C) Input mux register for SCT input 0                     */
	};
