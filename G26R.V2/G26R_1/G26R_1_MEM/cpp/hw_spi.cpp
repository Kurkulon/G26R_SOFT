...
static S_SPIM	spi(PIO_SPCK, PIO_MOSI, PIO_MISO, PIO_CS, SPCK, MOSI, MISO, SPI_PMUX_SPCK, SPI_PMUX_MOSI, SPI_PMUX_MISO, SPI_CS_MASK, ArraySize(SPI_CS_MASK), 
...
void SPI_Init()
{
	...
	spi.Connect(SPI_SERCOM_NUM, SPI_BAUDRATE);
